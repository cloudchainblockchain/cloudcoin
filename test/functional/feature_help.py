...
"""Verify that starting cloudcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start cloudcoin with -h for help text")
        ...
        self.log.info("Start cloudcoin with -version for version information")
        ...
        self.log.info("Start cloudcoind with -fakearg to make sure it does not start")
