Cloudcoin Core version *0.15.1* is now available from:

  <https://download.cloudcoin.org/cloudcoin-0.15.1/>
...
A number of changes to the way Cloudcoin Core deals with peer connections and invalid blocks
