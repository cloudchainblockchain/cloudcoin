...
* cloudcoin.conf: contains configuration settings for cloudcoind or cloudcoin-qt
* cloudcoind.pid: stores the process id of cloudcoind while running
...
* debug.log: contains debug information and general logging generated by cloudcoind or cloudcoin-qt
