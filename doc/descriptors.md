# Support for Output Descriptors in Cloudcoin Core

Since Cloudcoin Core v0.17, there is support for Output Descriptors in the
...
on Cloudcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Cloudcoin Core wallets, a convenience function `combo` is
