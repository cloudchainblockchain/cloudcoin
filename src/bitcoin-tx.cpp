...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s cloudcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  cloudcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cloudcoin transaction") + "\n" +
              "  cloudcoin-tx [options] -create [commands]   " + _("Create hex-encoded cloudcoin transaction") + "\n" +
              "\n";
