...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " cloudcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  cloudcoin-tx [options] <hex-tx> [commands]  Update hex-encoded cloudcoin transaction\n" +
            "or:     cloudcoin-tx [options] -create [commands]   Create hex-encoded cloudcoin transaction\n" +
            "\n";
