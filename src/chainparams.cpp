...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.cloudcoin.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.cloudcointools.com", true);
        vSeeds.emplace_back("dnsseed.cloudcoinpool.org", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.cloudcointools.com", true);
        vSeeds.emplace_back("seed-b.cloudcoin.loshan.co.uk", true);
