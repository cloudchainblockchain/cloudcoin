...
const char * const BITCOIN_CONF_FILENAME = "cloudcoin.conf";
const char * const BITCOIN_PID_FILENAME = "cloudcoind.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Cloudcoin";
#else
    // Unix
